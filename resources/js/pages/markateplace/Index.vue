...
<template>
  ...
  <div class="min-h-screen flex flex-col bg-gray-50">
    <!-- Hero Section -->
    <section
      class="relative bg-gradient-to-br from-emerald-600 to-emerald-500 py-16 md:py-20 overflow-hidden"
    >
      <div class="absolute inset-0 opacity-10">
        <div
          class="absolute top-0 left-0 w-64 h-64 bg-white rounded-full mix-blend-overlay blur-3xl"
        ></div>
        <div
          class="absolute bottom-0 right-0 w-64 h-64 bg-emerald-300 rounded-full mix-blend-overlay blur-3xl"
        ></div>
      </div>
              ...
              <nav class="flex items-center gap-1">
                <Link
                  ...
                  :class="[
                    ...
                    link.active ? 'bg-emerald-600 text-white' : 'text-gray-700 hover:bg-gray-100',
